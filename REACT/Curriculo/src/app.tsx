      ...
      <div className="w-[1044px]  border flex justify-between">
        ...
        <div className="w-3/4">
          <header className="flex flex-col items-center">
            <h1 className="mt-24 text-blue-800 text-6xl font-bold border-b-4  border-sky-300 ">HUMBERTO QUEIROZ</h1>
            <h2 className="text-3xl mt-10 border-b-2 border-sky-400">Desenvolvedor Web</h2>
          </header>
